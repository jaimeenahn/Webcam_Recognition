...
videoDir = 'output/video/test'
frameDir = 'output/frame/test'
    ...
    for filePath in files:
        ...
        while (cap.isOpened()):
            ...
            if k == 27:  # esc
                ...
                path2, dirs2, files2 = next(os.walk(frameDir + '/badget'))
                file_count = len(files2)
                cv2.imwrite(frameDir + '/badget/' + str(file_count) + '.jpg', resized)
            elif category == ord('x'):
                continue
